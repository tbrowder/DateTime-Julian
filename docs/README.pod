...
Provides routines to use astronomical Julian dates (sometimes called
I<Julian day numbers>)
...
The following methods and routines were developed from several sources
including those shown in the L<References|#References>. The author
of Ref. 3 has been very helpful with this author's questions
about astronomy, and much of his code has been ported to Raku
for this module. 
...
=head2 DateTime::Julian routines
